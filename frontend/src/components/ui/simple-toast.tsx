...
export function SimpleToastProvider({ children }) {
  ...
  return (
    <ToastContext.Provider value={{ showToast }}>
      ...
      {/* Toast Container */}
      <div className="fixed bottom-6 left-1/2 -translate-x-1/2 z-[100] flex flex-col-reverse gap-3 pointer-events-none">
          ...
          return (
            <div
              ...
              style={{
                ...
                transitionDelay: toast.visible ? `${index * 50}ms` : "0ms"
              }}
            >
              <div className="flex items-center gap-3 px-5 py-2 pr-10">
                {/* Icon */}
                <span className={cn(
